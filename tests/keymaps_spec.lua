...
function M.run()
    helpers.run_test_case("keymaps", function()
        helpers.with_mock(vim.api, "nvim_get_keymap", function()
            ...
            helpers.assert_has_hl(extmarks, "Identifier", "keymaps prefix hl")
            helpers.assert_has_hl(extmarks, "Type", "keymaps mode hl")
            helpers.assert_has_hl(extmarks, "Statement", "keymaps lhs hl")
